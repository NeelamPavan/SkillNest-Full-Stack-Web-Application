...
const Footer = () => {
    return (<footer className="py-[70px] bg-gray-10">
...
<div className="footer-col">
    ...
    <div className="flex flex-col gap-y-2">
        ...
        <a href="#instructors" className="footer-link">Instructors</a>
...
<div className="footer-col">
    ...
    <div className="flex flex-col gap-y-2">
        <a href="#" className="footer-link">Address: Telangana, Hyderabad</a>
        <a href="tel: +919363826091" className="footer-link">Phone: (+91) 9363826091</a>
        <a href="neelampava15@gmail.com" className="footer-link">
            Email: neelampavan@gmail.com</a>
    </div>
</div>
<div className="flex justify-between flex-wrap gap-4 p-10 mt-[70px] bg-gray-20 rounded-4xl ">
    <p className="text-lg text-gray-80">
        &copy; 2023 <span className="text-primary-50">SkillNest </span>All rights reserved      
    </p>
